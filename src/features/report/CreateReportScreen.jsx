        ...
        <TouchableOpacity style={styles.locationButton} onPress={getLocation}>
          {locating ? (
            ...
            <>
              ...
              <Text style={styles.locationButtonText}>Tap to detect location</Text>
            </>
          )}
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  photoButton: {
    flex: 1, backgroundColor: '#fff', borderRadius: 14, padding: 20, alignItems: 'center',
    borderWidth: 1, borderColor: '#E8EEE8', borderStyle: 'dashed',
  },
  ...
  input: {
    ...
    fontSize: 16, color: '#1A2E1A', borderWidth: 1, borderColor: '#E8EEE8',
  },
  textArea: { height: 120, textAlignVertical: 'top' },
  charCount: { fontSize: 12, color: '#A0ADA0', textAlign: 'right', marginTop: 4 },
  locationButton: {
    backgroundColor: '#fff', borderRadius: 14, padding: 16,
    borderWidth: 1, borderColor: '#E8EEE8', flexDirection: 'row', gap: 10, alignItems: 'center',
  },
  locationIcon: { fontSize: 20 },
  locationButtonText: { fontSize: 15, color: '#6B7C6B' },
  locationText: { fontSize: 15, color: '#2D7A5F', fontWeight: '600' },
  locationCoords: { fontSize: 12, color: '#6B7C6B', marginTop: 2 },
  submitButton: {
